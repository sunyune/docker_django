...
jQuery(document).ready(function ($) {
    $(".mumu").mouseover(function () {
       $(".mumu").fadeTo("300", 0.1);
       msgs = ["我隐身了，你看不到我", "我会隐身哦！嘿嘿！", "别动手动脚的，把手拿开！", "把手拿开我才出来！","告诉你个秘密：我单身哦"];
...
jQuery(document).ready(function ($) {
    window.setInterval(function () {
        ...
        var i2 = Math.floor(Math.random() * s.length);
            ...
            bottom:  document.body.offsetHeight/2*(1+s[i1])
        },
			{
			    duration: 2000,
...
//开始
jQuery(document).ready(function ($) {
    if (window.location.href == 'http://127.0.0.1:80/') { //如果是主页
...
jQuery(document).ready(function ($) {
    ...
    window.setInterval(function () {
        msgs = ["好无聊啊！", "好想做爱吖", "陪我聊天吧！", "你在干什么哦！", "好无聊哦，你都不陪我玩！", "…@……!………", "^%#&*!@*(&#)(!)(", "我可爱吧！嘻嘻!~^_^!~~","从前有座山，山上有座庙，庙里有个老和尚给小和尚讲故事，讲：“从前有座……”"];
        var i = Math.floor(Math.random() * msgs.length);
...
jQuery(document).ready(function ($) {
    ...
    $('input[name="commail"]').click(function () {
        showMessage("阁下邮箱是必不可少的哦，不然就是无头像人士了！");
        $(".spig").animate({
    ...
    $("#comment").click(function () {
        showMessage("阁下请认真填写哦！不然会被陛下处以死刑");
        $(".spig").animate({
